...
/// unnecessarily. It is intended to be used exclusively as a general interface on top of the two persistent key-value 
/// stores provided by Apple platforms: `UserDefaults` and `NSUbiquitousKeyValueStore`.
