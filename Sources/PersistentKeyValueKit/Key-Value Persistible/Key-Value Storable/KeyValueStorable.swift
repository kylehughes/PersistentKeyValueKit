...
public protocol KeyValueStorable<Storage> {
    ...
    func set(as userDefaultsKey: String, in userDefaults: UserDefaults)
    ...
    ///   `ubiquitousStoreKey`.
    func set(as ubiquitousStoreKey: String, in ubiquitousStore: NSUbiquitousKeyValueStore)
...
extension KeyValueStorable {
    ...
    /// Set the value, as `Storage`, at the given key in the given `UserDefaults`.
    ///
    /// - Parameter key: The key to set the value at.
    /// - Parameter userDefaults: The `UserDefaults` to set the value in, as `Storage`, at `key`.
    @inlinable
    ...
    ///
    /// - Parameter key: The key to set the value at.
    /// - Parameter ubiquitousStore: The `NSUbiquitousKeyValueStore` to set the value in, as `Storage`, at `key`.
    @inlinable
    public static func get(
        _ key: some PersistentKeyProtocol,
